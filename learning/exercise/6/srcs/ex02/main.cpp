...
int main() {
  ...
  // ------------------------------------
  Shader ourShader("resources/glsl/4.2.texture.vs",
                   "resources/glsl/4.2.texture.fs");
  ...
  while (!glfwWindowShouldClose(window)) {
    ...
    trans2 = glm::scale(
        trans2, glm::vec3(sin(glfwGetTime()), sin(glfwGetTime()), 1.0f));
    ourShader.setTransform("transform", trans2);
    glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, 0);
